...
public class Pistola extends Applet{
    ...
    private BranchGroup escenario(){
        ...
        TextureLoader archivo = new TextureLoader("src\\Fondojava\\fondopistola.jpg",this); //se carga la imagen del fondo
        ...
        objetoRaiz.addChild(pistola()); //se llama al metodo modelar objeto
        objetoRaiz.addChild(iluminar());
        return objetoRaiz;
    }
    private BranchGroup pistola(){
        BranchGroup objetoRaiz = new BranchGroup();
        ...
        producto.addChild(cargarObjeto("src\\Objeto\\M33.obj")); //se llama el metodo cargarObjeto y se le envia como parametro la ruta del archivo
        
        Alpha alpha = new Alpha(-1, 14000);
        
        Transform3D eje = new Transform3D();
        eje.setRotation(new AxisAngle4f(0.3f,4.0f,-1.0f,5.0f));
        RotationInterpolator position = new RotationInterpolator(alpha,producto,eje,90.0f,(float) Math.PI*(6.0f));
